...
export const TRADUCOES: Record<string, Record<Language, string>> = {
  ...
  // ==================== DASHBOARD (COMPLETO) ====================
'dashboard.titulo': { pt: 'Dashboard', en: 'Dashboard', fr: 'Tableau de Bord' },
'dashboard.bem_vindo': { pt: 'Visão geral da sua loja', en: 'Overview of your store', fr: 'Aperçu de votre boutique' },
'dashboard.total_produtos': { pt: 'Total de Produtos', en: 'Total Products', fr: 'Total Produits' },
'dashboard.total_pedidos': { pt: 'Total de Pedidos', en: 'Total Orders', fr: 'Total Commandes' },
'dashboard.faturamento': { pt: 'Faturamento', en: 'Revenue', fr: 'Chiffre d\'affaires' },
'dashboard.total_clientes': { pt: 'Total de Clientes', en: 'Total Customers', fr: 'Total Clients' },
'dashboard.ultimos_pedidos': { pt: 'Últimos Pedidos', en: 'Recent Orders', fr: 'Commandes Récentes' },
'dashboard.sem_pedidos': { pt: 'Nenhum pedido encontrado', en: 'No orders found', fr: 'Aucune commande trouvée' },
'dashboard.ver_todos': { pt: 'Ver todos', en: 'View all', fr: 'Voir tout' },
...
'admin.bem_vindo': { pt: 'Visão geral da sua loja', en: 'Overview of your store', fr: 'Aperçu de votre boutique' },


// Gestão de Produtos
'admin.produtos.novo': { pt: 'Novo Produto', en: 'New Product', fr: 'Nouveau Produit' },
'admin.produtos.editar': { pt: 'Editar Produto', en: 'Edit Product', fr: 'Modifier Produit' },
'admin.produtos.nome': { pt: 'Nome do Produto', en: 'Product Name', fr: 'Nom du Produit' },
'admin.produtos.descricao': { pt: 'Descrição', en: 'Description', fr: 'Description' },
'admin.produtos.preco': { pt: 'Preço (Kz)', en: 'Price (Kz)', fr: 'Prix (Kz)' },
'admin.produtos.estoque': { pt: 'Estoque', en: 'Stock', fr: 'Stock' },
'admin.produtos.imagem': { pt: 'Imagem URL', en: 'Image URL', fr: 'URL Image' },
'admin.produtos.salvar': { pt: 'Salvar', en: 'Save', fr: 'Enregistrer' },
'admin.produtos.atualizar': { pt: 'Atualizar', en: 'Update', fr: 'Mettre à jour' },
'admin.produtos.cancelar': { pt: 'Cancelar', en: 'Cancel', fr: 'Annuler' },
'admin.produtos.lista': { pt: 'Lista de Produtos', en: 'Product List', fr: 'Liste des Produits' },
'admin.produtos.acao': { pt: 'Ações', en: 'Actions', fr: 'Actions' },
// ==================== GESTÃO DE PRODUTOS ====================
'produtos.acoes': { pt: 'Ações', en: 'Actions', fr: 'Actions' },
'admin.produtos.acoes': { pt: 'Ações', en: 'Actions', fr: 'Actions' },

// ==================== GESTÃO DE UTILIZADORES ====================
'usuarios.nome': { pt: 'Nome', en: 'Name', fr: 'Nom' },
'usuarios.email': { pt: 'Email', en: 'Email', fr: 'Email' },
'usuarios.tipo': { pt: 'Tipo', en: 'Type', fr: 'Type' },
'usuarios.cliente': { pt: 'Cliente', en: 'Customer', fr: 'Client' },
'usuarios.admin': { pt: 'Administrador', en: 'Administrator', fr: 'Administrateur' },
'usuarios.descricao': { pt: 'Gerencie os utilizadores do sistema', en: 'Manage system users', fr: 'Gérez les utilisateurs du système' },
'usuarios.lista': { pt: 'Lista de Utilizadores', en: 'User List', fr: 'Liste des Utilisateurs' },

// Gestão de Pedidos
'admin.pedidos.lista': { pt: 'Lista de Pedidos', en: 'Order List', fr: 'Liste des Commandes' },
'admin.pedidos.status': { pt: 'Status', en: 'Status', fr: 'Statut' },
'admin.pedidos.cliente': { pt: 'Cliente', en: 'Customer', fr: 'Client' },
'admin.pedidos.total': { pt: 'Total', en: 'Total', fr: 'Total' },
'admin.pedidos.data': { pt: 'Data', en: 'Date', fr: 'Date' },
'admin.pedidos.buscar': { pt: 'Buscar pedido...', en: 'Search order...', fr: 'Rechercher une commande...' },
'admin.pedidos.todos': { pt: 'Todos os status', en: 'All status', fr: 'Tous les statuts' },
'admin.pedidos.detalhes': { pt: 'Ver Detalhes', en: 'View Details', fr: 'Voir Détails' },
'pedidos.descricao': { pt: 'Acompanhe e gerencie todos os pedidos', en: 'Track and manage all orders', fr: 'Suivez et gérez toutes les commandes' },
'pedidos.cliente': { pt: 'Cliente', en: 'Customer', fr: 'Client' },
'pedidos.acoes': { pt: 'Ações', en: 'Actions', fr: 'Actions' },
'pedidos.lista': { pt: 'Lista de Pedidos', en: 'Order List', fr: 'Liste des Commandes' },

// ==================== RELATÓRIOS (COMPLETO) ====================
'relatorios.titulo': { pt: 'Central de Relatórios', en: 'Reports Center', fr: 'Centre de Rapports' },
'relatorios.subtitulo': { pt: 'Exporte e analise dados da sua loja', en: 'Export and analyze your store data', fr: 'Exportez et analysez les données de votre boutique' },
'relatorios.disponiveis': { pt: 'Relatórios Disponíveis', en: 'Available Reports', fr: 'Rapports Disponibles' },
'relatorios.produtos': { pt: 'Produtos', en: 'Products', fr: 'Produits' },
'relatorios.produtos_desc': { pt: 'Lista completa do catálogo', en: 'Complete catalog list', fr: 'Liste complète du catalogue' },
'relatorios.pedidos': { pt: 'Pedidos', en: 'Orders', fr: 'Commandes' },
'relatorios.pedidos_desc': { pt: 'Todos os pedidos realizados', en: 'All orders placed', fr: 'Toutes les commandes passées' },
'relatorios.utilizadores': { pt: 'Utilizadores', en: 'Users', fr: 'Utilisateurs' },
'relatorios.utilizadores_desc': { pt: 'Clientes e administradores', en: 'Customers and administrators', fr: 'Clients et administrateurs' },
'relatorios.financeiro': { pt: 'Financeiro', en: 'Financial', fr: 'Financier' },
'relatorios.financeiro_desc': { pt: 'Resumo de faturamento', en: 'Revenue summary', fr: 'Résumé des revenus' },
'relatorios.exportar_csv': { pt: 'Exportar CSV', en: 'Export CSV', fr: 'Exporter CSV' },
'relatorios.ver_tudo': { pt: 'Ver tudo', en: 'View all', fr: 'Voir tout' },
'relatorios.ticket_medio': { pt: 'Ticket Médio', en: 'Average Ticket', fr: 'Ticket Moyen' },
'relatorios.produtos_lista': { pt: 'Lista Completa de Produtos', en: 'Complete Product List', fr: 'Liste Complète des Produits' },
'relatorios.pedidos_lista': { pt: 'Lista Completa de Pedidos', en: 'Complete Order List', fr: 'Liste Complète des Commandes' },
'relatorios.utilizadores_lista': { pt: 'Lista Completa de Utilizadores', en: 'Complete User List', fr: 'Liste Complète des Utilisateurs' },
'relatorios.detalhes_financeiros': { pt: 'Detalhes Financeiros', en: 'Financial Details', fr: 'Détails Financiers' },
'relatorios.metrica': { pt: 'Métrica', en: 'Metric', fr: 'Métrique' },
'relatorios.valor': { pt: 'Valor', en: 'Value', fr: 'Valeur' },
'relatorios.faturamento_total': { pt: 'Faturamento Total', en: 'Total Revenue', fr: 'Chiffre d\'affaires Total' },
'relatorios.total_pedidos': { pt: 'Total de Pedidos', en: 'Total Orders', fr: 'Total Commandes' },

// Gestão de Utilizadores
'admin.usuarios.lista': { pt: 'Lista de Utilizadores', en: 'User List', fr: 'Liste des Utilisateurs' },
'admin.usuarios.nome': { pt: 'Nome', en: 'Name', fr: 'Nom' },
'admin.usuarios.email': { pt: 'Email', en: 'Email', fr: 'Email' },
'admin.usuarios.tipo': { pt: 'Tipo', en: 'Type', fr: 'Type' },
'admin.usuarios.cliente': { pt: 'Cliente', en: 'Customer', fr: 'Client' },
'admin.usuarios.admin': { pt: 'Administrador', en: 'Administrator', fr: 'Administrateur' },
'admin.usuarios.sem': { pt: 'Nenhum utilizador encontrado', en: 'No users found', fr: 'Aucun utilisateur trouvé' },

// Relatórios
'admin.relatorios.titulo': { pt: 'Central de Relatórios', en: 'Reports Center', fr: 'Centre de Rapports' },
'admin.relatorios.subtitulo': { pt: 'Exporte e analise dados da sua loja', en: 'Export and analyze your store data', fr: 'Exportez et analysez les données de votre boutique' },
'admin.relatorios.produtos': { pt: 'Produtos', en: 'Products', fr: 'Produits' },
'admin.relatorios.pedidos': { pt: 'Pedidos', en: 'Orders', fr: 'Commandes' },
'admin.relatorios.utilizadores': { pt: 'Utilizadores', en: 'Users', fr: 'Utilisateurs' },
'admin.relatorios.financeiro': { pt: 'Financeiro', en: 'Financial', fr: 'Financier' },
'admin.relatorios.exportar_csv': { pt: 'Exportar CSV', en: 'Export CSV', fr: 'Exporter CSV' },
'admin.relatorios.ver_tudo': { pt: 'Ver tudo', en: 'View all', fr: 'Voir tout' },
'admin.relatorios.ticket_medio': { pt: 'Ticket Médio', en: 'Average Ticket', fr: 'Ticket Moyen' },
